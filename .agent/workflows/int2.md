---
description: Transform meeting transcripts into professional markdown summary documents. Use when users invoke "int2" with a transcript file.
---
...
- **Initial Discovery**: Read `.claude/skills/int2/references/initial_discovery_example.md`
- **Technical Discovery**: Read `.claude/skills/int2/references/tech_discovery_example.md`
...
- `.claude/skills/int2/references/initial_discovery_example.md` - Narrative format with sections like Key Business Context, Strategic Objectives, Technology Ecosystem, Pain Points, Success Criteria
- `.claude/skills/int2/references/tech_discovery_example.md` - Q&A format with status indicators covering Sources of Truth, Authentication, Integrations, Workflows, etc.
