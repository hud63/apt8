...
**Prompt location**: `.claude/skills/llmapper-skill/prompts/focusing-questions.md`
...
**Prompt location**: `.claude/skills/llmapper-skill/prompts/summarize.md`
...
**Prompt location**: `.claude/skills/llmapper-skill/prompts/rdf.md`
...
**Prompt location**: `.claude/skills/llmapper-skill/prompts/mermaid.md`
...
**Alternative**: For interactive HTML with drag/zoom/pan features, you can generate a Cytoscape visualization instead using `.claude/skills/llmapper-skill/prompts/cytoscape.md` which saves to `/tmp/[subject]-concept-map.html`
...
```
Apply .claude/skills/llmapper-skill/prompts/focusing-questions.md to generate 3 distinct focusing questions
...
### Step 3: Summarize
```
Apply .claude/skills/llmapper-skill/prompts/summarize.md with the chosen focusing question
...
### Step 4: Generate RDF
```
Apply .claude/skills/llmapper-skill/prompts/rdf.md to the concepts/relationships from step 3
...
```
Apply .claude/skills/llmapper-skill/prompts/mermaid.md to the RDF from step 4 silently
...
Apply .claude/skills/llmapper-skill/prompts/cytoscape.md to the RDF from step 4
...
e) Re-apply .claude/skills/llmapper-skill/prompts/mermaid.md (or cytoscape.md) to the UPDATED RDF
