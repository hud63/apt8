---
name: a8-brand
description: Apply Aptitude 8 corporate brand styling to presentations, documents, and spreadsheets. Use when the user invokes "a8-brand" or requests Aptitude 8/A8 branded materials. Automatically applies corporate colors (#F7CD46, #F5F5F5, #333333, #121212), modern typography, dark mode styling, and company logos to any created files.
---
...
When triggered, apply the Aptitude 8 brand guidelines to ensure consistent, professional output across all document types. The brand guidelines are detailed in `references/brand_guidelines.md` and should be referenced for specific color codes, font specifications, and UI styling patterns.
...
### Logos
Three logo variants are available via Cloudinary URLs (see `assets/logo_urls.md` for full URLs):
...
**Reference**: See `references/brand_guidelines.md` for complete specifications and logo download patterns
...
2. **Access logo URLs**: Refer to `assets/logo_urls.md` for Cloudinary URLs
